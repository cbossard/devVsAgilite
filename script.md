...
On ne voit plus de développeurs dans les conférences agiles, et on ne voir plus d'agilistes aux conférences de développeurs.
Certains développeurs ne veulent même plus entendre parler d'agilité.
On peut donc se demander pourquoi une telle scission ?

### Traumatisme
En discutant avec un certain nombre de développeurs, on constate qu'ils ont vécu l'agilité sur leur projet comme un traumatisme. Ils ne veulent surtout plus jamais travailler dans de telles conditions.
...
Typiquement, dans les conférences sur l'agilité, qui voyons-nous ? Il n'y a plus ni développeurs ni entrepreneurs. Seul reste le middle management qui cherche à justifier sa place en s'emparant de ces méthodes.
...
Les histoires de projets réussis grâce à l'agilité ont donné envie à de plus en plus de personnes qui s'y sont mises, sans pour autant en comprendre les valeurs intrinsèques.
...
### Excellence technique
"On est agile dans l'équipe ! On fait de la revue de code, de l'intégration continue, parfois quelques tests, et des estimations collectives"
Malheureusement, mon brave, c'est un package. On ne peut pas juste prendre les pratiques qui nous arrangent :
...
Et pour faire plaisir aux développeurs, on va ajouter un peu d'estimations collectives.
...
La popularisation de scrum, et de sa liste d'indicateurs comme les burndown, burnup, le management visuel associé à ces nouvelles pratiques ont permis aux managers de renforcer leur gestion par les indicateurs ("Top bien ! Plein de nouveaux KPIs !")
...
Ces indicateurs étaient supposés apporter de la transparence et permettre de lancer des alertes au plus tôt pour rectifier le tir. Ils ont été déviés de leur utilisation pour servir d'indicateurs sur la performance des personnes et sont même utilisés comme moyen de mesurer l'atteinte des objectifs définis lors des entretiens annuels.
...
### Les rétrospectives
Cette sorte d'idéalisation d'un monde parfait se retrouve également dans la manière dont sont réalisées les rétrospectives.
On ne parle pas des sujets qui fâchent (encore moins si le client participe à la rétro, quitte à en faire une "interne" pour laver son ligne sale en famille, et une autre avec le client).
...
Leur utilité peut se comprendre dans certaines conditions (pour faire passer certains messages ou concepts), mais pas systématiquement, pas de manière obligatoire, pas en mettant les personnes dans des conditions qu'ils considèrent inconfortables ou dégradantes. Le bizutage est interdit, pourquoi vouloir continuer ce genre de comportement en entreprise ?
De plus, l'utilisateur de jeux, même si cela permet de faire passer facilement des messages, accentue l'image décrédibilisante des développeurs qui sont des éternels enfants, que l'on peut amadouer avec des nerfs, des bonbons ou des tables de ping-pong.

## Non universalité
Même si l'agilité est désormais quelque chose de très populaire, ce n'est pas quelque chose d'universel.

### Transparence et communication
L'agilité implique une transparence et une surexposition de travail au quotidien.
...
Que faire des personnes qui ne se sentent pas à l'aise dans ce contexte de travail ?
Faut-il les pousser à rentrer dans le moule, les mettre en permanence en dehors de leur zone de confort ?
Pour certains, le travail n'est qu'alimentaire, et ils ont tout à fait le droit de ne pas vouloir s'impliquer
...
A l'origine, l'agilité était mise en place comme support à l'innovation. Ce n'est pas très étonnant que ce soient les startups qui ont
commencé à l'utiliser de manière intensive. Leur besoin de tester le produit le plus vite possible, de corrections, de changement de cap était
...
Cette course permanente pour vider le backlog peut être épuisante à terme.
...
si elle résout les problèmes qui la concernent et s'améliore au fil du temps, c'est une équipe avec laquelle il fait bon travailler !
...
Lorsqu'un artisan intervient chez vous, est-ce que vous lui imposez quels outils il doit utiliser ? Si il vient accompagné d'un apprenti, est-ce que vous lui refusez sa présence (parce que bon, il va le ralentir et y'a pas besoin de deux personnes pour réparer ce toit qui fuit quand même). Je pense que vous serez très heureux de pouvoir compter sur l'apprenti qui aura eu l'opportunité de partager l'expérience de l'artisan et qui aura déjà une très bonne connaissance du chantier.
...
## Agile != A.G.I.L.E
Vous pouvez tout à fait être agiles dans votre travail quotidien, sans pour autant être estampillé A.G.I.L.E. par la hiérarchie.
L'agilité, c'est un état d'esprit, des valeurs, une envie de travail bien fait et utile à l'utilisateur final.
Pas la peine de chercher un nouveau nom pour rebaptiser la volonté de faire du travail de qualité, dans un environnement bienveillant pour produire des logiciels utiles aux utilisateurs.
